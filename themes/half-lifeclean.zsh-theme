...
setopt prompt_subst
PROMPT="$vcs_info_msg_0_${orange}✗ %{$reset_color%}${purple}%n%{$reset_color%} ${limegreen}%~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${orange} λ%{$reset_color%} "
